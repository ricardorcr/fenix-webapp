...
public class CreateAdmissionsDataInternational extends CustomTask {

    private static final Locale PT = new Locale("pt", "PT");
    private static final Locale EN = new Locale("en", "GB");
//    private static final String DIR = "/home/rcro/DocumentsHDD/fenix/candidaturas/";
    private static final String DIR = "/afs/ist.utl.pt/ciist/fenix/fenix015/ist/";
    private static final String FORM_DATA_FILENAME = DIR + "form-data-international-3phase.json";
    private static final String DEGREES_DATA_FILENAME = DIR + "international_3rd_phase_2021_2022.csv";
...
//                });
    ...
    private void createInternational() throws Exception {
        final LocalizedString title = ls(
                "Candidaturas para Estudantes Internacionais 2021/2022 - 3ª Fase",
                "International Applicants 2021/2022 - 3rd Phase"
        );
        final DateTime startDate = new DateTime(2021,07,26,0,0);
        final DateTime endDate = new DateTime(2021,8,06,23,59, 59);;
