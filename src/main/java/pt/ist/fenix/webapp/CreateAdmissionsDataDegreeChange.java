...
public class CreateAdmissionsDataDegreeChange extends CustomTask {
...
//                    });
    ...
    private void createDegreeChange() throws Exception {
        final LocalizedString title = ls("Candidaturas Mudança de Par Instituição/Curso 2021/2022", "Change of Course/Institution Applicants 2021/2022");
        final DateTime startDate = new DateTime(2021,07,05,0,0);
        final DateTime endDate = new DateTime(2021,07,23,23,59, 59);
        final LocalizedString tags = ls("Mudança Curso 2021/2022", "Degree Change 2021/2022");

        final AdmissionProcess admissionProcess = AdmissionProcess.createAdmissionProcess(
                title,
                startDate,
                endDate,
                "https://tecnico.ulisboa.pt/pt/ensino/estudar-no-tecnico/candidaturas-e-inscricoes/mudanca-de-par-instituicao-curso/",
                tags,
