...
public class ManualSyncFinancialInfoToSapTask extends CustomTask {

    //TODO não está a fazer a sincronização!!
    ...
    private void runSyncScript() throws IOException, AddressException, MessagingException {
        ...
        //EventProcessor.syncEventWithSap(errorLogConsumer, elogger, FenixFramework.getDomainObject("562975723227434"));
