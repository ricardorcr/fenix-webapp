...
public class CreateAdmissionsData2ndCycle extends CustomTask {
    ...
    private static final String FORM_DATA_FILENAME = "/afs/ist.utl.pt/ciist/fenix/fenix015/ist/2ndCycleFormData.json";
    ...
    public void runTask() throws Exception {
        ...
        AdmissionsSystem.getInstance().getAdmissionProcessSet().stream()
                .filter(admissionProcess -> admissionProcess.getTitle().getContent(PT).contains("2º Ciclo"))
...
//                    });
    ...
    private void create2ndCycle() throws Exception {
        final LocalizedString title = ls("Candidaturas 2º Ciclo 2021/2022", "Master’s Degree  Applicants 2021/2022");
        final DateTime startDate = new DateTime(2021,06,01,0,0);
        final DateTime endDate = new DateTime(2021,07,31,23,59, 59);
        final LocalizedString tags = ls("Segundo Ciclo 2021/2022", "Second Cycle 2021/2022");

        final AdmissionProcess admissionProcess = AdmissionProcess.createAdmissionProcess(
                title,
                startDate,
                endDate,
                "https://tecnico.ulisboa.pt/pt/ensino/estudar-no-tecnico/candidaturas-e-inscricoes/mestrados/",
                tags,
        ...
        final AdmissionProcessCost admissionProcessCost = admissionProcess.addAdmissionProcessCost(
                ls("Emolumento de candidatura (normal)", "Application fee (normal)"), new BigDecimal(100));
